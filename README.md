...
If you add the path `node_modules/debug-draw.cxx` to your compiler's include paths.

```bash
$ clang++ -I./node_modules/debug-draw.cxx main.cxx  # or, use g++
$ g++     -I./node_modules/debug-draw.cxx main.cxx
```
...
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/glampert/debug-draw)
